...
/** This program demonstrates the math functions from the C math.h library, so that you can get your homework right
    thanks to some quick-and-easy programming.
 */
...
int main()
{
    ...
    printf("The cosine o a 60-degree angle is %.3f\n", cos((60 * (3.14159 / 180.0))));
