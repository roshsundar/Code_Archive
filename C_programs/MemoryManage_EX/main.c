...
/** The program looks for a number of random integers, allocates an array and fills it with numbers between 1 and
    500 and then loops through all the numbers and figures out the smallest, the biggest, and the average. It then frees
    the memory.
 */
...
int main()
{
    ...
    /** Loop through the now filled array testing for the random numbers that are the biggest, smallest, and adding
        all the numbers together to calculate an average
     */
     ...
     /** When you allocate memory, remember to free it */
