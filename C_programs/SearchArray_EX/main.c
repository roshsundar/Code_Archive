...
/** This program takes an ID number from the user and then checks the Id against a list of customers in the database.
    If the customer exists, it uses that array element to check their current balance, and warns the user if the balance
    is more than 100.
 */
...
int main()
{
    ...
    /** Defines the 10 elements in the 2 parallel arrays */
