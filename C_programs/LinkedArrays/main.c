...
/** This program fills three arrays with a player's total points, rebounds, and assists. It loops through the scoring
    array and finds the game with the most points. Once it knows that information, it prints the totals from all 3
    categories from that game.
 */
...
int main()
{
    ...
    for (i = 0; i < 10; i++)
    {
        /** the if loop will compare each game to the current best total. If the current score is higher, it becomes
            the new best and the counter variable becomes the new flag gmMark
         */
